...
// 每堆都有 正 整数颗石子，数目为 piles[i] 。游戏以谁手中的石子最多来决出胜负。
// 石子的 总数 是 奇数 ，所以没有平局。Alice 和 Bob 轮流进行，Alice 先开始 。
...
public class _877_石子游戏{
    ...
    class Solution2 {
        ...
        // 他不管怎么拿，第 2 堆又会暴露出来，你就可以拿。同理，如果你想拿奇数堆，你就拿第 1 堆，留给对手的只有第 2、4 堆，
        // 他不管怎么拿，第 3 堆又给你暴露出来了。

        // 也就是说，你可以在第一步就观察好，奇数堆的石头总数多，还是偶数堆的石头总数多，然后步步为营，就一切尽在掌控之中了。
        // 知道了这个漏洞，可以整一整不知情的同学了。
        public boolean stoneGame(int[] piles) {
            return true;
        }
    }
